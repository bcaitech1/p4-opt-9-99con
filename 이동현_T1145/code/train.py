...
def train(
    ...
    # model_instance.model.load_state_dict(torch.load('exp/2021-06-15_10-50-52_2305721/best.pt', map_location=device))
    ...
    # optimizer = SGDP(model_instance.model.parameters(), lr=data_config["INIT_LR"], weight_decay=1e-2, momentum=0.9, nesterov=True)
    # optimizer = AdamP(model_instance.model.parameters(), lr=data_config["INIT_LR"], betas=(0.9, 0.999), weight_decay=1e-2)
