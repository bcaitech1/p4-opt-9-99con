...
class Model(nn.Module):
    ...
    def __init__(
        ...
        if 'model_name' in self.cfg:
            self.model = TVModel(self.cfg['model_name'], pretrained=self.cfg['pretrained'])
        else:
            self.model_parser = ModelParser(cfg=self.cfg, verbose=verbose)
